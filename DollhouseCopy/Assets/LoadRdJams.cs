...
public class LoadRdJams : MonoBehaviour
{
    public GameObject RdTriggerGroup;
    ...
    public Canvas loadRdJamsButton;
    ...
    void OnTriggerEnter(Collider player)
    {
        ...
        if (player.tag == "thisplayer")
        {
            ...
            RdTriggerGroup.GetComponent<RdTriggers>().enabled = true;

            if (!hasdownloaded)
            {

                loadRdJamsButton.enabled = true;
    ...
    void OnTriggerExit(Collider player)
    {
        ...
        if (player.tag == "thisplayer")
        {
            ...
            loadRdJamsButton.enabled = false;
            ...
            RdTriggerGroup.GetComponent<RdTriggers>().enabled = false;
