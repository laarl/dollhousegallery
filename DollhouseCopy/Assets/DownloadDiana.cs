...
public class DownloadDiana : MonoBehaviour
{

    public GameObject DianaTriggerGroup;
    ...
    void OnTriggerEnter(Collider player)
    {
        ...
        if (player.tag == "thisplayer")
        {
            ...
            DianaTriggerGroup.GetComponent<DianaTriggers>().enabled = true;
    ...
    void OnTriggerExit(Collider player)
    {
        ...
        if (player.tag == "thisplayer")
        {
            ...
            */
            ...
            DianaTriggerGroup.GetComponent<DianaTriggers>().enabled = false;
